...
def confustion_matrix(prediction_list,image_name,plot_cm = True):
    ...
    report = classification_report(y_ground_truth, y_predicted, target_names=target_names)
    return (report)
...
def callback(current_epoch_values,previous_epoch_values,model,model_name):
